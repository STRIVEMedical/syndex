...
// #include "USB.h"
// #include "Wire.h"
// #include "usb_packet_logger.h" // For logging joint angles
// #include "joint.h"
// #include <cstddef>
...
//             // Switch all ODrive-backed joints to position control once on entry.
//             // Doing this inside the per-iteration loop floods the CAN bus.
//         for (int i = 0; i < NUM_JOINTS; i++) {
...
//             delay(20);
//             pumpEvents(can_intf);  // flush per joint
//             SerialUSB1.print("[READY] Joint "); SerialUSB1.print(i);
//             SerialUSB1.println(" → position control, pos_gain=30");
//             printOdriveError(joints[i].odrive, i);
...
//                     continue;
//                 }
//                 float pos = joints[i].user_data ? joints[i].user_data->last_feedback.Pos_Estimate : -999.0f;
//                 float err = joints[i].home_pos - pos;
//                 SerialUSB1.print("[DEBUG] Joint "); SerialUSB1.print(i);
//                 SerialUSB1.print(" odrive="); SerialUSB1.print(joints[i].odrive != nullptr);
//                 SerialUSB1.print(" pos="); SerialUSB1.print(pos, 4);
//                 SerialUSB1.print(" home="); SerialUSB1.print(joints[i].home_pos, 4);
//                 SerialUSB1.print(" err="); SerialUSB1.println(err, 4);
...
//                     allArrived = false;
//                 } else {
//                     SerialUSB1.print("[HOMING] Joint "); SerialUSB1.print(i); SerialUSB1.println(" within tolerance.");
//                 }
//             }
...
//             // SerialUSB1.print('subState: RESTORING');
